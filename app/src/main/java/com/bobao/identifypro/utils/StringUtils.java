...
public class StringUtils {
    ...
    public static SpannableStringBuilder getMultiColorString(int color, String text, String... segments) {
        Spannable textWrapper = Spannable.Factory.getInstance().newSpannable(text);
        return getMultiColorString(color, textWrapper, segments);
     ...
     */
    public static SpannableStringBuilder getMultiColorString(int color, Spannable text, String... segments) {

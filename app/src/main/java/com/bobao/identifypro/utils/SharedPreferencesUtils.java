...
public class SharedPreferencesUtils {
    ...
    public static void setSharedPreferencesDouble(Context context, String str, double i) {
        if (context == null) {
            return;
        }
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public static double getSharedPreferencesDouble(Context context, String str, double def) {
        if (context == null) {
            return def;
        }
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        if (sharedPreferences != null && !TextUtils.isEmpty(sharedPreferences.getString(str, "0.0"))) {
            return Double.valueOf(sharedPreferences.getString(str, "0.0"));
        }
        return def;
    }

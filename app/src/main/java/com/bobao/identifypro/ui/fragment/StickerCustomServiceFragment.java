 ...
 */
public class StickerCustomServiceFragment extends StickHeaderRecyclerViewFragment {
    private static StickerCustomServiceFragment mInstance;
    private static String mType;
    private static String mTypeName;
    private StickerServiceAdapter mServiceAdapter;

    // 不完全单例
    public static StickerCustomServiceFragment getInstance(String type, String typeName) {
        if (mInstance == null) {
            mInstance = new StickerCustomServiceFragment();
        }
        mType = type;
        mTypeName = typeName;
        return mInstance;
